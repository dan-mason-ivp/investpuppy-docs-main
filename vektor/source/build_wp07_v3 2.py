...
def build():
    ...
    security = [
        ...
        ('Data residency',
         ...
         'data residency guarantees follow. Full commitments available to Founding Mandate partners.'),
        ('Network isolation',
    ...
    not_in_scope = [
        ...
        ('Production environment promotion',
         ...
         'the first Founding Mandate client is onboarded\u2014a defined trigger condition, not an open-ended roadmap item.'),
