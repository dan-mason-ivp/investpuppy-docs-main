...
chg = [
    ...
    [p('Founding Mandate: conditional proof-of-concept framing', s_tbl_v),
...
comp2 = [
    ...
    [p('Position', s_tbl_k), p('Home page: below Five Reasons, above Founding Mandate form', s_tbl_v)],
...
arch = [
    ...
    [p('/', s_code), p('Home', s_tbl_v),
     p('Qualify & intrigue', s_tbl_k), p('Founding Mandate form', s_tbl_v),
     p('', s_tbl_k)],
    ...
    [p('/why-vektor', s_code), p('Why Vektor', s_tbl_v),
     p('Make the commercial case', s_tbl_k), p('Founding Mandate \u2192', s_tbl_v),
     p('', s_tbl_k)],
    ...
    [p('/research', s_code), p('Research', s_tbl_v),
     ...
     p('', s_tbl_k)],
    [p('/founding-mandate', s_code), p('Founding Mandate', s_tbl_v),
...
story.append(note_box('Updated nav order',
    ...
    'Founding Mandate \u00b7 The Story \u00b7 Documents\n'
    ...
    '"Founding Mandate" remains visually distinct: gold text, subtle gold border.',
    gold=False))
...
for el in page_spec(
    ...
    'Has one clear next action: enquire about the Founding Mandate.',
    [
        ('HERO\n(Full viewport)',
         ...
         'Any number of concurrent mandates.\nCTA: Enquire about Founding Mandate \u2192'),
        ('THE PROBLEM\n(3-column)',
...
for el in page_spec(
    ...
    [
        ...
        ('PAGE CTA', 'Link to Founding Mandate', '[UNCHANGED FROM v1.0]'),
    ]
):
    story.append(el)
story.append(sp(8))
...
for el in page_spec(
    ...
    'Is ready for due diligence or a Founding Mandate conversation.',
    [
        ('INVESTPUPPY\nQUESTION\n(Top of page)',
        ...
        ('PAGE CTA', 'Links to Founding Mandate + Research',
         '[UNCHANGED FROM v1.0]'),
    ]
):
    story.append(el)
...
for el in page_spec(
    ...
    [
        ...
        ('PAGE CTA',
         'Proof-of-concept offer \u00b7 link to Founding Mandate',
...
for el in page_spec(
    ...
    [
        ...
        ('CROSS-REF',
         'Links to Platform and Founding Mandate',
         '[UNCHANGED FROM v1.0]'),
    ]
):
    story.append(el)
...
for el in page_spec(
    '/founding-mandate', 'Founding Mandate', 'PAGE 06  \u00b7  UPDATED',
    ...
    [
        ...
        ('SCOPE NOTE\n[NEW]',
         ...
         '"The Founding Mandate Programme is currently open to teams '
...
for el in page_spec(
    ...
    [
        ...
        ('CROSS-REF',
         'Links to Research and Founding Mandate',
         '[UNCHANGED FROM v1.0]'),
    ]
):
    story.append(el)
