"""
Vektor DD Navigation Guide — updated to include Proof Partners programme document.
...
def draw_cover(canvas, doc):
    ...
    canvas.drawCentredString(W/2, 28*mm, 'For Proof Partners and institutional due diligence teams')
...
def build():
    ...
    story.append(NoteBox(COL_W,
        ...
        'navigation tool. The recommended sequence for a Proof Partner due diligence process is at the end.',
        s['body']))
    ...
    doc_entry('Why Vektor',
        ...
        'The market problem, the DPM workflow, the Proof Partners proposition. Contains a summary of the '
        'Proof Partners programme on page\u00a06.',
        story, s)

    doc_entry('Proof Partners programme',
        'What exactly is the Proof Partners programme? What are the commercial terms, obligations, and programme mechanics?',
        ...
        'for the full programme detail. Reference: IP-PPR-260515-1.0.',
        story, s)
    ...
    story.append(HRule(COL_W, RULE_MAJ, 1.0, 2, 6))
    story.append(Paragraph('RECOMMENDED SEQUENCE \u2014 PROOF PARTNERS DUE DILIGENCE', s['sec']))
    ...
    story.append(Paragraph(
        ...
        '\u2605 Proof Partners programme (IP-PPR-260515-1.0) \u2014 read after Why Vektor.',
    ...
    story.append(Paragraph(
        ...
        'Vektor is currently distributed in Singapore, configured and validated on SGX (Singapore), LSE (UK), and US equities. '
        'UK commercial distribution is subject to regulatory review. Managers based outside Singapore may engage '
        'through InvestPuppy directly. '
