...
def build():
    ...
    p('Vektor does not yet have a live track record with real client capital. The platform is operational in simulation mode and the full workflow \u2014 from research through execution \u2014 has been tested and validated. The Proof Partners programme exists specifically to begin building a live track record under real conditions, with partners who understand they are participating in the early stage of platform development.',s['body']),
    NoteBox(COL_W,
        'The Proof Partners proposition is explicit: early partners accept the absence of a live track record '
    ...
    checklist=[
        ...
        ('What is the rebalancing frequency, and what are the transaction costs?',
         ...
         'Until it is live, Proof Partners are advised to apply cost assumptions to any Sharpe ratio '
