"""The First 90 Days — Proof Partners onboarding guide. vk5 build."""
import sys, os
...
def draw_cover(canvas, doc):
    ...
    canvas.drawCentredString(W / 2, 29 * mm,
        'For Proof Partners \u2014 provided at mandate signing')
...
story += [
    ...
    sp(4),
    p('The founding partner is not a beta tester and not a trial user. They are a '
...
story += [
    ...
    p('The first Proof Partner is not receiving a proven process. They are '
