...
def build():
    ...
    items_strategic = [
        ('S-01',
         ...
         'implement before any Proof Partner outreach begins',
    ...
    items_product = [
        ...
        ('PR-03',
         ...
         'data to evaluate. For an institutional investor making a Proof Partner commitment, '
        ...
        ('PR-06',
         ...
         'The Proof Partners programme is presumably the answer to this \u2014 early partners '
         'get direct founding-team access and a more hands-on onboarding. But since the '
         'Proof Partners programme has not been fully defined in any document, this '
         'reassurance is not currently available to a prospect reading the suite.',
         'Define the onboarding and implementation process as part of the Proof Partners programme '
         'Programme document. At minimum add an FAQ answer: Q13. What does implementation '
         'look like and what support is available?',
         'Proof Partners programme (IP-PPR-260515-1.0), FAQ',
         'PRODUCT'),
        ...
        ('PR-08',
         ...
         'but provides no signal about the people behind it. The Proof Partners programme '
         ...
         'Proof Partners programme. Not a CV \u2014 a voice.',
         'Why Vektor (page 2), Proof Partners programme (introduction)',
         'PRODUCT'),
    ]
    ...
    items_uk = [
        ('UK-01',
         ...
         'The complete commercial document suite \u2014 brochure, FAQ, Why Vektor, Proof Partners programme, '
    ...
    all_items = [
        ...
        ('P-03', 'NaN% in strategy view screenshot',
         'Fix calculation bug + retake', 'PLATFORM', 'Before Proof Partner distribution'),
        ('P-04', 'KYC PENDING/ACTIVE inconsistency in client screenshots',
         'Retake with clean data', 'PLATFORM', 'Before Proof Partner distribution'),
        ...
        ('S-01', 'investpuppy.com: mailto vs waitlist form',
         'Implement form capture', 'STRATEGIC', 'Before Proof Partner outreach begins'),
        ...
        ('PR-06', 'Onboarding process and implementation risk unaddressed',
         'Define in FMP doc + FAQ Q13', 'PRODUCT', 'Before Proof Partner outreach'),
        ...
        ('PR-08', 'Founder biography and voice absent from all commercial documents',
         'Add founder note to Why Vektor + FMP', 'PRODUCT', 'Before Proof Partner outreach'),
