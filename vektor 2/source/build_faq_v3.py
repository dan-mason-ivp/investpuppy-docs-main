...
def build():
    ...
    qa('Q7. Which markets does Vektor support?',
       'Any listed equity market. The platform has been configured and validated on SGX (Singapore), LSE (UK), and US equities. '
       'Any additional listed equity market is a configuration. Exchange, benchmark, currency, and lot sizes are configuration parameters, '
       'not hard-coded values. The SGX example is used for illustration because it was the initial deployment market. '
       'Managers running mandates across multiple markets \u2014 a Singapore-based DPM managing SGX, US, and '
       'Hong Kong exposures concurrently, for example \u2014 run all mandates on a single platform instance. '
       'There is no per-market fee and no separate configuration required.',
    ...
    qa('Q10. What is the Proof Partners programme?',
       'The Proof Partners programme is the early-commitment programme for boutique DPMs, EAMs, '
       'independent wealth managers, and family offices committing before the platform has a live '
       'track record. Proof Partners receive preferential commercial terms locked for the duration '
       '\u2014 at one tier below their AUM tier, with Entry tier as the permanent floor \u2014 '
       'direct access to the founding team, and direct influence over the product roadmap. '
       'In exchange, they are committing before live performance history exists. The programme is '
       'limited to three slots.',
       'See: vk5-proof-partners.pdf \u00b7 investpuppy.com/proof-partners', s, story)
    story.append(sp(4))
    ...
    qa('Q11. Does Vektor have a live track record?',
       ...
       'That is the primary milestone the Proof Partners programme first production period achieves. '
       'A live track record begins with the first Proof Partner. '
       ...
       'See: WP-09: Risk Disclosure (read this first) \u00b7 WP-10: Evaluating Performance Without a Track Record \u00b7 Proof Partners programme (IP-PPR-260515-1.0)', s, story)

    qa('Q12. What does Vektor cost?',
       'Vektor uses AUM-tiered annual subscription pricing. Entry tier (up to USD 55M AUM): USD 18,000/year. '
       'Growth tier (USD 55M\u2013USD 185M): USD 36,000/year. Institutional tier (USD 185M\u2013USD 550M): USD 80,000/year. '
       'Enterprise (USD 550M+): from USD 125,000/year. '
       'All tiers are positioned materially below the Bloomberg Terminal + PORT spend for a firm at the same AUM level. '
       'Proof Partners receive a 12-month founding rate at USD 13,500/year, then permanently '
    ...
    qa('Q13. Is Vektor regulated?',
       ...
       'Specific regulatory standing and applicable permissions by jurisdiction are discussed in the Proof Partner '
    ...
    qa('Q15. Can you demonstrate Vektor on our data?',
       'Yes. Pick any mandate you currently manage \u2014 any listed equity market, any currency, any benchmark, including cross-market mandates spanning multiple exchanges. '
       ...
       'Become a Proof Partner at investpuppy.com/proof-partners',
       s, story)
