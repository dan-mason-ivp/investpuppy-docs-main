"""
Vektor Proof Partners programme — standalone document
...
IP_H_RATIO = 2.337
DOC_DATE  = 'May 2026'
DOC_REF   = 'IP-PPR-260515-1.0'
DOC_SUB   = 'Proof Partners programme'
...
def draw_cover(canvas, doc):
    ...
    try:
        ...
        canvas.drawCentredString(W/2, rule_y - 48, 'Proof Partners programme')
    ...
    canvas.drawCentredString(W/2, 28*mm,
        'For prospective Proof Partners only \u2014 strictly confidential')
...
def build():
    ...
    doc = BaseDocTemplate(out, pagesize=A4,
        ...
        title='Vektor Proof Partners programme',
        author='InvestPuppy')
    ...
    story.append(p('Pick any listed equity market, any currency, any benchmark. '
        ...
        S))
    story.append(p('This is the Proof Partners proposition: engage with the platform '
    ...
    story.append(NoteBox(COL_W,
        'The Proof Partners programme is a structured early-access partnership between Vektor and a small number of '
        'institutional wealth management firms. Proof Partners are not beta testers. They are the firms '
    ...
    advantages = [
        ('You shape the platform, not inherit it.',
         ...
         'Proof Partners define the workflows, approval structures, reporting formats, and integration '
        ...
        ('Commercial terms reflect your risk, not the market rate.',
         'Proof Partners are committing before live production. The commercial terms reflect that '
         'commitment \u2014 not the pricing a platform commands once it has an established track record. '
         'Proof Partners receive a 12-month founding rate of USD 13,500/year — 25% below the standard entry tier — '
         'followed by permanent preferential pricing at one tier below their AUM tier. '
         'A partner whose AUM grows from USD 55M to USD 290M will pay the Growth tier rate, not the '
        ...
        ('Your mandate becomes the live track record.',
         'The first Proof Partner produces the platform\u2019s live performance history. That track record '
    ...
    for item in sec('1.', 'WHAT THE PARTNER RECEIVES',
        'Specific benefits of Proof Partners programme status \u2014 commercial, operational, and strategic.', S):
        story.append(item)
    ...
    story.append(NoteBox(COL_W,
        ...
        'The commercial terms are structured in two stages: a 12-month founding rate at USD 13,500/year, '
    ...
    benefits = [
        ('Preferential commercial terms \u2014 structured and permanent',
         'Proof Partners programme pricing operates in two stages. Stage one: a 12-month founding rate of '
         ...
         'with Entry tier (USD 18,000/year) as the permanent floor. '
         'A Proof Partner whose AUM grows to S$400M pays the Growth tier rate (USD 36,000/year), '
         'not the Institutional rate (USD 80,000/year) \u2014 permanently. '
         'The distinction between Proof Partners and subsequent clients does not close. '
         'It reflects the commitment made at a specific moment in the platform\u2019s development.'),
        ('Direct roadmap influence',
         'Proof Partners participate in structured quarterly roadmap sessions with the founding team. '
        ...
        ('Priority onboarding and dedicated implementation support',
         'Proof Partners receive dedicated implementation support from the founding team through '
        ...
        ('Full technical and compliance documentation',
         ...
         'disclosure, and compliance architecture are available in full to Proof Partners as part '
        ...
        ('Early access to new capabilities',
         ...
         'options, walk-forward validation \u2014 are available to Proof Partners before general '
         'release. Partners have the option to participate in capability development or to receive new '
         'features as they are released.'),
        ('Recognition as a Proof Partner',
         'Where a Proof Partner chooses to be identified publicly, Vektor will acknowledge their '
         'founding status in appropriate contexts. Partners who prefer not to be identified publicly are not '
         'required to be. Proof Partners who choose public recognition become part of the '
    ...
    for item in sec('2.', 'WHAT THE PARTNER COMMITS TO',
        'The obligations of Proof Partners programme status \u2014 stated directly.', S):
        story.append(item)

    story.append(NoteBox(COL_W,
        'The Proof Partners programme is a genuine partnership, not a one-sided commercial arrangement. '
        ...
        'The following commitments are standard across all Proof Partners programme arrangements.',
        S['body']))
    story.append(sp(10))

    obligations = [
        ('Minimum mandate commitment',
         'A Proof Partners programme requires a minimum active mandate on the platform \u2014 specific AUM threshold '
        ...
        ('Structured feedback participation',
         'Proof Partners participate in quarterly structured reviews with the founding team. '
        ...
        ('Reference arrangement \u2014 subject to agreement',
         'Proof Partners are asked \u2014 not required \u2014 to serve as a reference for prospective '
         ...
         'Partners who prefer not to participate in reference arrangements retain full Proof Partners programme '
    ...
    story.append(p(
        'Proof Partners programme pricing operates in two stages. The founding rate of USD 13,500/year applies '
    ...
    pricing_data = [
        ...
        [Paragraph('Stays \u2264USD 55M',   price_cell_style),
         Paragraph('Entry  USD 18,000',     price_grey_style),
         Paragraph('Entry  USD 18,000',     price_gold_style),
         Paragraph('Floor (yr 2+)',       price_grey_style)],
        [Paragraph('Grows to S$150M',     price_cell_style),
         Paragraph('Growth  USD 36,000',    price_grey_style),
         Paragraph('Entry  USD 18,000',     price_gold_style),
         Paragraph('S$24,000 (50%)',      price_gold_style)],
        [Paragraph('Grows to S$400M',     price_cell_style),
         Paragraph('Institutional  USD 80,000', price_grey_style),
         Paragraph('Growth  USD 36,000',    price_gold_style),
         Paragraph('S$60,000 (56%)',      price_gold_style)],
        [Paragraph('Grows to S$1B+',      price_cell_style),
         Paragraph('Enterprise  USD 125,000+', price_grey_style),
         Paragraph('Institutional  USD 80,000', price_gold_style),
    ...
    story.append(sp(12))
    story.append(p(
        'The programme has a maximum of three Proof Partners programme slots. Slot allocation follows '
    ...
    story.append(p(
        'Proof Partners are selected on the basis of: operational fit (the platform addresses '
    ...
    story.append(p(
        ...
        'one tier below the partner\u2019s current AUM tier, with Entry tier (USD 18,000/year) '
        ...
        'A partner whose AUM remains below USD 55M moves to Entry tier (S$24,000). '
    ...
    story.append(NoteBox(COL_W,
        ...
        'AWS account before the first Proof Partner is onboarded into live trading. This is a '
    ...
    cta_children = [
        ...
        Paragraph('Three steps from this document to a Proof Partner engagement.',
