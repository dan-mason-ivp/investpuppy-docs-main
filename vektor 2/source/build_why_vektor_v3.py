...
def build():
    ...
    for title,body in [
        ...
        ('Regulatory standing.',
         'Vektor is a portfolio construction and management platform. Regulatory status, jurisdiction, and applicable permissions are not disclosed in this document \u2014 full details are available to prospective partners on request as part of the Proof Partner due diligence process.'),
    ]:
        story.append(p(title,S_subh)); story.append(p(body,S_body))
    ...
    terms=[('Slots available','Three founding partners \u2014 specific, scarce, selected. Once full, the programme closes.'),
           ...
           ('Commercial terms','12-month founding rate of USD 13,500/year, then permanently one tier below your AUM tier.'),
    ...
    try:
        ...
        cta_children=[
            ...
            p('Become a Proof Partner at investpuppy.com/proof-partners',S_cta_g),
    ...
    story.append(p(
        ...
        'For the complete Proof Partners programme specification \u2014 commercial structure, partner '
        'obligations, programme mechanics, and path to production \u2014 see the Proof Partners programme '
        'document (IP-PPR-260515-1.0). All documents available at investpuppy.com.',S_xref))
    story.append(sp(8))
