...
def draw_cover(canvas, doc):
    ...
    try:
        ...
        canvas.drawCentredString(W/2,ry-82,
            'who it is for, and how it fits the Proof Partners sales journey.')
...
def build():
    ...
    story.append(NoteBox(COL_W,
        ...
        'against the seven stages of the Proof Partners sales journey. For each document: what it is, '
    ...
    comm_rows=[
        ...
        # FMP NEW ENTRY
        [Paragraph('Proof Partners programme \u25b6 NEW',s['new_tag']),
         Paragraph('vk5-proof-partners.pdf',s['tbl_mono']),
         ...
         Paragraph('Prospective Proof Partners (post-NDA)',s['tbl_body'])],
    ]
    ...
    sup_rows=[
        inv_row('Due Diligence Navigation Guide','vektor-dd-navigation-guide.pdf',
                ...
                'Proof Partners, institutional DD teams'),
    ...
    stage(1,'COLD OUTREACH','First contact \u2014 no prior relationship',[
        [action('SEND',s), doc_name('Vektor at a Glance',s),
         ...
         notes('One page. Establishes what Vektor is and the Proof Partners programme concept. Low commitment ask \u2014 easy to forward.',s)],
    ],
    ...
    stage(2,'FIRST TOUCH MEETING','Interest established \u2014 30-minute intro call',[
        [action('PRESENT',s), doc_name('Deck 4 \u2014 Lightning Deck',s),
         ...
         notes('6 slides. Commercial argument and Proof Partners proposition. Designed to fit a 20-minute slot with 10 minutes for questions.',s)],
    ...
    stage(3,'60-MINUTE SALES MEETING','Decision-maker in the room',[
        [action('PRESENT',s), doc_name('Deck 1 \u2014 60-Minute Meeting',s),
         ...
         notes('12 slides. Full platform story, workflow integration map, risk honesty slide, Proof Partners proposition. Sequenced: context \u2192 platform \u2192 workflow fit \u2192 risks \u2192 FMP.',s)],
    ...
    stage(4,'SERIOUS CONVERSATION','NDA signed \u2014 substantive due diligence begins',[
        ...
        [action('SEND',s), doc_name('Proof Partners programme',s),
         fn('vk5-proof-partners.pdf',s),
         notes('Send at this stage \u2014 the first time commercial terms and programme structure are discussed in detail. Reference: IP-PPR-260515-1.0.',s)],
    ...
    stage(7,'FOUNDING MANDATE CLOSE','Commercial terms and onboarding',[
        [action('PRESENT',s), doc_name('Deck 3 \u2014 Institutional Partner',s),
         ...
         notes("13 slides. Partnership framing \u2014 'a different kind of partnership.' Integration architecture. Proof Partners programme commercial terms. Designed for the close conversation with the principal.",s)],
        [action('REFERENCE',s), doc_name('Proof Partners programme',s),
         fn('vk5-proof-partners.pdf',s),
    ...
    'signed Proof Partners programme agreement. Onboarding scoped. Platform configuration begins.',
    story, s)
    ...
    rules=[
        ...
        ('Always send the Proof Partners programme document at Stage 4',
         'The FMP (vk5-proof-partners.pdf) is the first document that defines commercial terms and programme obligations in full. It should be sent when the NDA is signed, not withheld until Stage 7. A partner who arrives at Stage 7 without having read the FMP is unprepared for the close conversation.'),
