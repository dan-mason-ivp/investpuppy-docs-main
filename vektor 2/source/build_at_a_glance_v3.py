...
def build():
    ...
    story.append(para(
        ...
        'Configured and validated on SGX (Singapore), LSE (UK), and US equities. '
        'Any listed equity market is a configuration. '
    ...
    plat_body = (
        ...
        'prices, and produces a fully auditable, trade-ready position set. Any listed equity market. Any currency. Configured and validated on SGX, LSE, and US equities. Any listed equity market is a configuration.')
    result_body = (
        ...
        'Run all your mandates \u2014 across any listed equity market, any currency \u2014 on a single platform. Configured and validated on SGX (Singapore), LSE (UK), and US equities. Any listed equity market is a configuration.')
    three_col=[
    ...
    reasons=[
        ...
        ('05','Any market. Any currency. All your mandates.',
         'One platform for every mandate you manage \u2014 regardless of exchange, currency, or client domicile. Configured and validated on SGX, LSE, and US equities. Any listed equity market is a configuration.'),
    ]
    ...
    fmp_left_body=(
        'Proof Partners programme \u2014 currently onboarding a small number of wealth teams managing '
    ...
    fmp_right_body='<b>Enquire about Proof Partners programme\navailability investpuppy.com</b>'
